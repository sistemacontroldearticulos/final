...
?>
            ...
            <div class="col-xs-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="nuevaFechaInicio" name="nuevaFechaInicio" placeholder="Ingrese Fecha Inicio" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask  disabled required >
            ...
            <div class="col-xs-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="nuevaFechaFin" name="nuevaFechaFin" placeholder="Ingrese Fecha Fin" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask disabled onchange="validacion2()">
...
?>
            ...
            <div class="col-xs-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarFechaInicio"  id="editarFechaInicio" placeholder="Ingrese Fecha Inicio" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask required disabled>
